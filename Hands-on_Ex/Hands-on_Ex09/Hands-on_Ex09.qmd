...
Constructing the adaptive bandwidth geospatial weighted regression model
...
Saving adaptive bandwidth geospatial weighted regression model

```{r}
write_rds(gwr_adaptive, "data/aspatial/gwr_adaptive.rds")
```

Displaying model output for Geospatial Weighted regression using adaptive bandwidth
